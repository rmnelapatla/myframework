...
/////////////////////////////////////////////////////////////////////
 ...
 //fAddEvent(2008,4,2," Click me to active your email client. ","popup('mailto:any@email.address.org?subject=email subject')","#87ceeb","dodgerblue",null,true);
 //fAddEvent(2008,4,1, "Don't B Fool!\nYou can't select me.", null, "#87ceeb", "dodgerblue");
...
function fHoliday(y,m,d) {
	...
	if (m==1&&d==1)
		...
		r=[" Jan 1, "+y+" \n Happy Republic Day ",gsAction,"skyblue","red"];
	else if (m==8&&d==15)
		r=[" Aug 15, "+y+" \n Independence Day ",gsAction,"skyblue","red"];
	else if (m==3&&d==8)
		r=[" Mar 8, "+y+" \n Women's Day ",gsAction,"skyblue","red"];
	else if (m==5&&d==1) {
		r=[" May 1, "+y+" \n May Day! ",gsAction,"skyblue","red"];
	}
	else if (m==2&&d==14){
		r=[" May 1, "+y+" \nValentine's Day! ",gsAction,"skyblue","red"];
