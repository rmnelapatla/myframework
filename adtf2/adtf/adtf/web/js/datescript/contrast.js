...
var gcCalBG="#E6ECD9";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#d2ECD9";	// the background color of the inner table, showing as a frame.
var gsInnerTable="border=0 cellpadding=1 cellspacing=2";	// HTML tag properties of the inner <table> tag, which holds all the calendar cells.
...
var gsNavPrev="<IMG id='navPrev' class='MonthNav' src='left2.jpg' width='20' height='20' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG id='navNext' class='MonthNav' src='right2.jpg' width='20' height='20' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var gcWorkday="#009900"; // Workday font color
var gcSat="#09698e";	// Saturday font color
var gcSatBG=null;	// Saturday background color
var gcSun="#09698e";	// Sunday font color
var gcSunBG="#FFFFFE";	// Sunday background color
...
var gcBGToday="#09698e";	// the background color for today 
var guTodayBGImg="bigCross.gif";	// url of image as today's background
...
var gsTodayTip=new Date();	// tooltip for today
...
var guSelectedBGImg="bigCross.gif";	// url of image as background of the selected date
...
var gAgendaMask=[-1,-1,gcCellBG,"#E6ECD9",-1,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.js. Check the tutorial for details.
