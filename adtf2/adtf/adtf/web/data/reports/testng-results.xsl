...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="writeCssFile" >
        ...
        <xsl:result-document
            format="text"
            href="{testng:absolutePath(&apos;style.css&apos;)}" >
...
<![CDATA[
    ...
    <xsl:template name="writeJsFile" >
        ...
        <xsl:result-document
            format="text"
            href="{testng:absolutePath(&apos;main.js&apos;)}" >
<![CDATA[
...
d
        ...
        <xsl:if test="($durationMs > 3600000) and ($durationMs mod 86400000 > 1000)" >
            ...
            <xsl:value-of select="format-number(($durationMs mod 86400000) div 3600000, &apos;#&apos;)" />
h
        </xsl:if>
        ...
        <xsl:if test="$durationMs &lt; 86400000" >
            ...
            <xsl:if test="($durationMs > 60000) and ($durationMs mod 3600000 > 1000)" >
                ...
                <xsl:value-of select="format-number(($durationMs mod 3600000) div 60000, &apos;#&apos;)" />
m
            </xsl:if>
            <!-- Seconds -->
...
:
    ...
    <xsl:template match="/testng-results" >
        ...
        <xsl:result-document
            format="xml"
            href="{testng:absolutePath(&apos;overview-chart.svg&apos;)}" >
...
Passed (
                    ...
                    <rect
                        style="fill:yellow;stroke-width:1;stroke:black;"
                        height="20"
                        width="20"
                        x="10"
                        y="163" />
...
Skipped (
        ...
        <xsl:result-document
            format="xhtml"
            href="{testng:absolutePath(&apos;overview.html&apos;)}" >
...
, 
        ...
        <xsl:result-document
            format="xhtml"
            href="{testng:absolutePath(&apos;reporterOutput.html&apos;)}" >
...
Reporter output
    ...
    <xsl:template name="navigationFile" >
        ...
        <xsl:result-document
            format="xhtml"
            href="{testng:absolutePath(&apos;navigation.html&apos;)}" >
                                ...
                                <tr>
                                    ...
                                    <td nowrap="true" >
                                        ...
                                        <b>
                                            ...
                                            <a
                                                href="{testng:suiteContentFileName(.)}"
                                                onclick="javscript:clearAllSelections();"
                                                target="content" >
                                        ...
                                        <div style="margin: 3px 0 3px 0;" >
                                            ...
                                            <a
                                                href="{testng:suiteGroupsFileName(.)}"
                                                onclick="javscript:clearAllSelections();"
                                                target="content" >
    ...
    <xsl:template name="testMethods" >
        ...
        <div style="width: 200px;" >
            ...
            <label
                ...
                for="groupMethodsCheckBox" >

                <input
                    id="groupMethodsCheckBox"
            ...
            <label
                style="font-weight: bold; margin: 0;"
                for="methodsFilter_ALL" >

                <input
                    id="methodsFilter_ALL"
        ...
        <label
            ...
            for="methodsFilter_FAIL" >

            <input
                id="methodsFilter_FAIL"
...
Exception
    ...
    <xsl:template name="testMethodsList" >
        ...
        <xsl:for-each select="$methodList" >
            ...
            <xsl:variable
                name="exceptionDetailsId"
                select="concat($methodId, &apos;_exception&apos;)" />

            <tr
                id="{concat($methodId, &apos;_row&apos;)}"
...
&lt;No stacktrace information&gt;
    ...
    <xsl:template name="percentageOverview" >
        ...
        <td
            style="background-color: #FFBBBB; padding: 3px 3px 3px 0;"
            align="center" >
        ...
        <td
            style="background-color: lightgreen; padding: 3px 3px 3px 0;"
            align="center" >
        ...
        <td
            style="background-color: #FFFFBB; padding: 3px 3px 3px 0;"
            align="center" >
    ...
    <xsl:template name="powered-by" >
        ...
        <div style="margin-top: 15px; color: gray; text-align: center; font-size: 9px;" >
            ...
            <a
                style="color: #8888aa;"
                href="http://code.google.com/p/testng-xslt/"
                target="_blank" >
                TestNG XSLT
            </a>
        </div>
